...
exports.scopedGlobals = exports.overwrittenGlobals = void 0;
...
exports.overwrittenGlobals = overwrittenGlobals;
var scopedGlobals = Array.from(new Set([].concat((0, _toConsumableArray2.default)(_globals.globals), overwrittenGlobals, ['requestAnimationFrame'])));
exports.scopedGlobals = scopedGlobals;
