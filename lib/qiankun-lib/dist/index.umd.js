(function (global, factory) {
	...
	var overwrittenGlobals = ['window', 'self', 'globalThis'];
	var scopedGlobals = Array.from(new Set([].concat(_toConsumableArray(globals), overwrittenGlobals, ['requestAnimationFrame'])));
	        ...
	        case SCRIPT_TAG_NAME:
	          {
	            ...
	            var scopedGlobalVariables = speedySandbox ? scopedGlobals : [];
	            if (src) {
	 ...
	 */
	var unscopables = without_1.apply(void 0, [globals].concat(accessingSpiedGlobals, _toConsumableArray(overwrittenGlobals))).reduce(function (acc, key) {
